...
function calcular(){
    ...
    //Faixa 1
    document.getElementById('fx1_aliquota') .innerText = faixa1_aliq.toLocaleString('pr-BR', {style: 'decimal', currency: 'BRL'})+'%';
    ...
    //Faixa 2
    document.getElementById('fx2_aliquota') .innerText = faixa2_aliq.toLocaleString('pr-BR', {style: 'decimal', currency: 'BRL'})+'%';
    ...
    //Faixa 3
    document.getElementById('fx3_aliquota') .innerText = faixa3_aliq.toLocaleString('pr-BR', {style: 'decimal', currency: 'BRL'})+'%';
